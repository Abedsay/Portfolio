  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative flex max-h-[calc(100dvh-2rem)] w-full max-w-2xl flex-col rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] outline-none sm:max-h-[calc(100dvh-3rem)]"
      >
        <button
          ref={closeButtonRef}
          onClick={onClose}
